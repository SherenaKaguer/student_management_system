...
-- create branches  and push file in git
-- git checkout -b feature/student-database
-- git add student.sql
-- git commit -m "Add student database schema and sample data"
-- git push origin feature/student-database
